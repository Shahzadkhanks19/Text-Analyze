      ...
      <div className="container">
        ...
        <div className="accordion" id="accordionExample">
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body" style={myStyle}>
                TextAnalyze gives you a way to analyze your text quickly and
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body" style={myStyle}>
                TextAnalyze is a free character counter tool that provides
                instant character count and word count statistics for a given
                text. TextAnalyze reports the number of words and characters.
